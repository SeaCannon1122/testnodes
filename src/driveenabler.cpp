...
class driveenabler : public rclcpp::Node
{
public:
  driveenabler() : Node("driveenabler") {
    ...
    drive_enable_pub_ = this->create_publisher<std_msgs::msg::Bool>("/n10/drive_enable", 10);
    getmsgs();
  }
...
private:
  ...
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr drive_enable_pub_;
...
int main(int argc, char * argv[])
{
  ...
  auto node = std::make_shared<driveenabler>();
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}
